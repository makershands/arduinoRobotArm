...
long int forservo1 = 30200;
long int forservo2 = 19800;
long int forservo3 = 22300;
long int forservo4 = 30000;
...
void loop() {
  ...
  if(forservo1  > 50000) forservo1 = 50000; // if forservo1 is greater than 20000, then it's equal to 20000
  ...
  if(forservo4  > 30000) forservo4 = 30000;
  
  // forservo 값을 서보 모터 각도 값으로 매핑함. Angles are adjusted during testing 
  angle1 = map(forservo1, 1, 50000, 180, 10);
  angle2 = map(forservo2, 1, 40000, 180, 8);
  angle3 = map(forservo3, 1, 40000, 180, 0);
  angle4 = map(forservo4, 1, 30000, 80, 0);
  ...
  //Serial.print(angle1); Serial.print("\t"); Serial.print(angle2); Serial.print("\t"); Serial.print(angle3); Serial.print("\t"); Serial.println(angle4); //Serial.print("\t");
